...
function CategoryDesc(props) {
  return (
    ...
    <div className='w-[1280px] border m-auto p-6'>
      ...
      <h3 className='mx-3 text-slate-500 text-[12px] '>Answer Lorem ipsum, dolor sit amet consectetur adipisicing elit. At fuga rem quas reprehenderit, ut dolores minus neque ducimus possimus alias, ratione quibusdam debitis aspernatur cupiditate praesentium distinctio non excepturi temporibus.</h3>
